...
IPAddress ip(192, 168, 86, 240);                       // Definição do endereço IP que a Ethernet Shield terá na rede onde estiver conectada. Verifique a Máscara-de-subrede e todos os equipamentos conectados na rede para achar um IP compatível e livre.
                    ...
                    if (mainPageRequest(&HTTP_req)) {
                        ...
                        client.println("</form>");
                           ...
                           client.println("<br/>");
                            ...
                            //ALTERAÇÃO DA LEITURA DO SENSOR DE TEMPERATURA
                            //INICIO
                            float temperatura=0;
                            for(int i=0;i<1000;i++) {
                                temperatura=temperatura+analogRead(A1);
                            }
                            temperatura=temperatura/1000;
                            //temperatura=temperatura*(1.1/1024);
                            temperatura=temperatura*(5.0/1024);
